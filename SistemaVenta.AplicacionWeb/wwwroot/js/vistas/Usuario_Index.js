...
$("#btnGuardar").click(function () {
    ...
    if (inputs_sin_valor.length > 0) {
        const mensaje = `Debe completar al campo : "${inputs_sin_valor[0].name}"`;
        ...
        fetch("Usuario/Editar", {
            ...
            .then(responseJson => {
                ...
                if (responseJson.estado) {
                    ...
                    $("#modalData").modal("hide")
                    swal("Listo!", "El usuario fue modificado con exito", "success")
                } else {
                    swal("Lo sentimos", responseJson.mensaje, "error")
                }
            })
                ...
                fetch(`Usuario/Eliminar?IdUsuario=${data.idUsuario}`, {
                    ...
                    .then(responseJson => {
                        ...
                        if (responseJson.estado) {
                            ...
                            swal("Listo!", "El usuario fue eliminado con exito", "success")
                        } else {
                            swal("Lo sentimos", responseJson.mensaje, "error")
                        }
                    })
