        ...
        public AutoMapperProfile()
        {
            ...
            CreateMap<Venta, VMVenta>()
                ...
                opt => opt.MapFrom(origen => origen.IdUsuarioNavigation.Nombre)
                   ...
                   .ForMember(destino =>
                destino.SubTotal,
                 opt => opt.MapFrom(origen => Convert.ToString(origen.SubTotal, new CultureInfo("es-ES")))
                )
                   .ForMember(destino =>
            ...
            CreateMap<DetalleVenta, VMReporteVenta>()
                ...
                opt => opt.MapFrom(origen => Convert.ToString(origen.IdVentaNavigation.SubTotal, new CultureInfo("es-ES")))
                )
                 .ForMember(destino =>
