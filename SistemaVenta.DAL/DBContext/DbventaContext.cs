...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CA38870F6");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FD321BAED");
            ...
            entity.HasOne(d => d.IdVentaNavigation).WithMany(p => p.DetalleVenta)
                ...
                .HasConstraintName("FK__DetalleVe__idVen__7A672E12");
        });

        modelBuilder.Entity<Menu>(entity =>
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4839F3491AA");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E10710B6A73A");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EBC416294");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1320852DE2D");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76AF09725A");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D891607D86");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE1F3FD4CC");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6EAF3DF85");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614496624CA");
            ...
            entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK__Venta__idTipoDoc__75A278F5");
